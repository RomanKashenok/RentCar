 ...
 * status 'finished'.
 */
public class UserShowArchiveOrdersCommand implements ICommand {
    ...
    public String execute(HttpServletRequest request) throws CommandException {
        ...
        try {
            List<Order> acceptedOrderList = orderService.findOrdersByUserIdAndStatus((int) request.getSession().getAttribute(USER_ID), OrderStatus.FINISHED);
