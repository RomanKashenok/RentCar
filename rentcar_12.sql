...
-- Дамп данных таблицы rentcar2.car: ~6 rows (приблизительно)
...
INSERT IGNORE INTO `car` (`id_car`, `manufacturer`, `model`, `vin`, `colour`, `issueDate`, `transmission`, `engine_capacity`, `fuelConsumpting`, `engineType`, `price`, `carStatus`) VALUES
	...
	(7, 'Subaru', 'impreza', 'shfsh56dg4jd6gm', 'black red', '2006-01-01', 'mechanic', 1500, 10, 'gasoline', 600, 1);
/*!40000 ALTER TABLE `car` ENABLE KEYS */;

-- Дамп данных таблицы rentcar2.car_status: ~2 rows (приблизительно)
...
-- Дамп данных таблицы rentcar2.order: ~10 rows (приблизительно)
...
INSERT IGNORE INTO `order` (`id_order`, `id_car`, `id_user`, `orderDate`, `returnDate`, `status`, `coast`, `cancelMessage`) VALUES
	...
	(24, 4, 3, '2016-02-14', '2016-02-16', 1, 2400, '123'),
	(25, 3, 3, '2016-02-04', '2016-02-06', 4, 1600, ''),
	(26, 1, 3, '2016-02-02', '2016-02-06', 4, 600, ''),
	(27, 2, 3, '2016-02-11', '2016-02-14', 2, 2100, ''),
	(29, 2, 3, '2016-02-20', '2016-02-25', 1, 3500, 'hsrhsjdj etjdjd eu ed'),
	(30, 1, 7, '2016-02-16', '2016-02-28', 3, 6960, ''),
	(31, 2, 3, '2016-02-16', '2016-02-18', 3, 1400, ''),
	(32, 7, 9, '2016-03-01', '2016-03-05', 2, 2400, '');
/*!40000 ALTER TABLE `order` ENABLE KEYS */;

-- Дамп данных таблицы rentcar2.order_status: ~2 rows (приблизительно)
...
INSERT IGNORE INTO `penalty` (`id_penalty`, `id_user`, `id_order`, `id_car`, `sum`, `message`, `isPayed`) VALUES
	...
	(8, 3, 25, 3, 1100, 'царапина на бампере + туст', 1);
/*!40000 ALTER TABLE `penalty` ENABLE KEYS */;

-- Дамп данных таблицы rentcar2.user: ~7 rows (приблизительно)
/*!40000 ALTER TABLE `user` DISABLE KEYS */;
INSERT IGNORE INTO `user` (`id_user`, `login`, `password`, `email`, `first_name`, `last_name`, `passportNumber`, `balance`, `id_role`) VALUES
	(3, 'poi', '1uHAXIqBwq50x67epeySwQ==', 'kashenok.r@mail.ru', 'Роман', 'Кашенок', 'MP2723773', 0, 3),
	...
	(7, 'roma', 'LpLRiNvb2I58FYMfSr/h/A==', 'roma@tut.by', 'Роман', 'Кашенок', 'MPO723773', 2540, 2),
	(8, 'okm', 'sLyuGONKLIgUbCmN4KZJXg==', 'okm@okm.okm.oi', 'роман', 'романыч', 'BV1598745', NULL, 2),
	(9, 'Kate', 'Kd3CiAmSZMF7B7r0TT8K3A==', 'kate@kate.com', 'Екатерина', 'Е', 'HB4563214', 2600, 2);
/*!40000 ALTER TABLE `user` ENABLE KEYS */;

-- Дамп данных таблицы rentcar2.user_role: ~2 rows (приблизительно)
